...
export function Loudness({ width, height }: Props) {
  ...
  useAnimationFrame(() => {
    ...
    ctx.textAlign = "center";
    glowText(ctx, "TP", tpCenterX, padding.top + 16, "#B7C5F4", "rgba(183,197,244,0.35)");
    ...
    for (let b = 0; b < barCount; b++) {
      const barX = padding.left + b * barStep;
      glowText(ctx, bars[b].label, barX + barWidth / 2, canvasHeight - padding.bottom + 12, "#B7C5F4", "rgba(183,197,244,0.35)");
    }
    ctx.font = "7px monospace";
